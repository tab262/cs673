...
public class ArtHttpClient extends GenericSeeker{

	private DefaultHttpClient client = new DefaultHttpClient();

	
//To call the Server API and accept the Json and return it in a string format 
	public ArtInfoDataModel retrieve(String url)
	{
		HttpGet getRequest=new HttpGet(url);
		ArtInfoDataModel  frontpageobj=new ArtInfoDataModel();
		...
		try{
			...
			JsonArtPage jsondeserialze=new JsonArtPage(EntityUtils.toString(getResponseEntity));
