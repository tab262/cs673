...
public class MuseumHttpClient extends GenericSeeker{
...
//To call the Server API and accept the Json and return it in a string format 
	public MuseumHomePageData retrieve(String url)
	{
		HttpGet getRequest=new HttpGet(url);
		MuseumHomePageData  frontpageobj=new MuseumHomePageData();
		...
		try{
			...
			JsonMuseumHomePage jsondeserialze=new JsonMuseumHomePage(EntityUtils.toString(getResponseEntity));
